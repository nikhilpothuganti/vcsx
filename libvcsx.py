...
import grp, pwd # User and group information

from fnmatch import fnmatch # Filename matching

import hashlib # Hashing functions, like SHA1

from math import ceil # Math functions, like ceil()

import os # Operating system functions, like file handling
...
def tag_create(repo, name, ref, create_tag_object=False):
    ...
    if create_tag_object:
        ...
        tag.kvlm[b'tagger'] = b'vcsx <vcsx@example.com>'
        # …and a tag message!
        tag.kvlm[None] = b"A tag generated by vcsx, which won't let you customize the message!\n"
...
def index_read(repo):
    ...
    assert version == 2, "vcsx only supports index file version 2"
